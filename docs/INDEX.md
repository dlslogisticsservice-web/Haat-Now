...
The single entry point to all project documentation. See **[README.md](README.md)** for the folder-hierarchy
guide and **[CHANGELOG_DOCS.md](CHANGELOG_DOCS.md)** for the full move log.
...
| Find a service + its owner | [governance/SERVICE_REGISTRY.md](governance/SERVICE_REGISTRY.md) |
| Read the latest sprint report | [phases/](phases/) |
| Check production/launch readiness | [production/](production/) · [qa/](qa/) |
...
- [Phase 0.2 — Theme Presets](phases/PHASE_0_2_IMPLEMENTATION_REPORT.md)
- [Phase 0.3 — Brand Asset Manager](phases/PHASE_0_3_IMPLEMENTATION_REPORT.md) · [Integration](phases/PHASE_0_3_INTEGRATION_REPORT.md)
- [Phase 0.4 — Provisioning Engine](phases/PHASE_0_4_IMPLEMENTATION_REPORT.md)
- [Phase 0.5 — Template Marketplace](phases/PHASE_0_5_IMPLEMENTATION_REPORT.md)
- [Phase 0.6 — Onboarding Wizard](phases/PHASE_0_6_IMPLEMENTATION_REPORT.md)
- [Phase 0.7 — Tenant Control Center](phases/PHASE_0_7_IMPLEMENTATION_REPORT.md)
