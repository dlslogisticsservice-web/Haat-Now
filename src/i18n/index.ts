...
const ar = {
  ...
  auth: {
    ...
    emailLabel: 'البريد الإلكتروني', emailPlaceholder: 'you@example.com', enterEmail: 'أدخل بريدك الإلكتروني للمتابعة', otpSentEmail: 'تم إرسال رمز التحقق إلى بريدك الإلكتروني.', changeEmail: 'تغيير البريد', sending: 'جارٍ الإرسال', verifying: 'جارٍ التأكيد',
    invalidCode: 'الرمز المدخل غير صحيح', sendError: 'خطأ في إرسال الرمز',
    continueGuest: 'الدخول كزائر', or: 'أو',
    signIn: 'تسجيل الدخول', confirmCode: 'تأكيد الرمز', enterPhone: 'أدخل رقم هاتفك للمتابعة', codeSentTo: 'أُرسل رمز التحقق إلى', orContinueWith: 'أو المتابعة عبر', sandboxHint: ' وضع التجربة: استخدم customer.eg@haatnow.test والرمز 123456', noCode: 'لم يصلك الرمز؟', terms1: 'من خلال الاستمرار، فإنك توافق على', termsLink: 'شروط الخدمة', and2: 'و', privacyLink: 'سياسة الخصوصية',
  },
  home: {
    ...
    noMerchants: 'لا توجد متاجر متاحة بعد', noMerchantsSub: 'نعمل على إضافة متاجر في منطقتك قريباً.',
  },
  ...
  restaurant: { meals: 'الوجبات', products: 'المنتجات', offers: 'العروض', reviews: 'التقييمات', about: 'عن المتجر', aboutStore: 'عن المتجر', addToCart: 'إضافة للسلة', addToYourCart: 'أضف لسلتك', viewCart: 'عرض السلة', rating: 'التقييم', delivery: 'التوصيل', deliveryTime: 'وقت التوصيل', minOrder: 'الحد الأدنى', minOrderFull: 'الحد الأدنى للطلب', openNow: 'مفتوح الآن', status: 'الحالة', name: 'الاسم', category: 'الفئة', premiumItem: 'صنف عالي الجودة يحضر فورياً عند طلبكم.', featuredOffers: 'العروض المميزة', loadingMenu: 'جاري جلب القائمة...', menuUnavailable: 'قائمة هذا الفرع غير متوفرة حالياً', noReviews: 'لا توجد تقييمات بعد. كن أول من يقيّم بعد استلام طلبك.', orderNow: 'اطلب الآن', offerSampleTitle: '30% خصم', offerSampleSub: 'على جميع وجبات كومبو العائلية', customerReviews: 'آراء العملاء', chooseSize: 'اختر الحجم:', luxuryRestaurant: 'مطعم فاخر', mostOrderedMeals: 'الأكثر طلباً' },
  ...
  wallet: {
    ...
    redeem: 'استبدل', redeemHint: 'رصيد محفظة', transactions: 'العمليات الأخيرة', noTransactions: 'لا توجد عمليات بعد', noTransactionsSub: 'ستظهر هنا عمليات محفظتك بعد أول طلب.', viewAllTx: 'عرض كل المعاملات',
...
const en = {
  ...
  auth: {
    ...
    emailLabel: 'Email address', emailPlaceholder: 'you@example.com', enterEmail: 'Enter your email to continue', otpSentEmail: 'A verification code has been sent to your email.', changeEmail: 'Change email', sending: 'Sending', verifying: 'Verifying',
  ...
  home: {
    ...
    noMerchants: 'No stores available yet', noMerchantsSub: 'We are adding stores in your area soon.',
  },
  ...
  wallet: {
    ...
    redeem: 'Redeem', redeemHint: 'wallet credit', transactions: 'Recent activity', noTransactions: 'No transactions yet', noTransactionsSub: 'Your wallet activity will appear here after your first order.', viewAllTx: 'View all transactions',
